...
public class Login extends javax.swing.JFrame {
     private ClienteMapDAO clienteMapDao;
    /**
     * Creates new form Login
     */
    public Login() {
        initComponents();
        clienteMapDao = new ClienteMapDAO();
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/telasaula/logo-vacina-facil-4 (1).png"))); // NOI18N
    ...
    private void CadastroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CadastroActionPerformed
        ...
        this.dispose();
        Login.getNewInstancia().setVisible(true);
    ...
    Cliente clienteCadastrado = clienteMapDao.consultarPorUsuario(username);
    if (clienteCadastrado != null) {
        System.out.println("Usuário encontrado: " + clienteCadastrado.getUser());
        if (clienteCadastrado.getSenha().equals(password)) {
